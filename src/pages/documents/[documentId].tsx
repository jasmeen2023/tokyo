...
import FieldAgent from '@/content/Cases/Quote/FieldAgent';
import TaskOverview from '@/content/Cases/Quote/TaskOverview';
import TasksAnalytics from '@/content/Cases/Quote/TasksAnalytics';
