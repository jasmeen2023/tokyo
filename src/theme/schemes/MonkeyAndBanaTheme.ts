...
const colors = {
  gradients: {
    ...
    blue4: 'linear-gradient(-20deg, #3AA8D9 0%, #4B65B2 100%)',
...
export const MonkeyAndBanaTheme = createTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
  ...
  palette: {
    ...
    background: {
      paper: colors.alpha.trueWhite[70],
    ...
    MuiInputBase: {
      styleOverrides: {
        root: {
          ...
          '&.Mui-focused:hover .MuiInputBase-root': {
      ...
      styleOverrides: {
        root: {
          '&.MuiButtonBase-root': {
            ...
            '&:hover, &:active, &.active, &.Mui-selected': {
              color: colors.primary.main,
              // background: alpha(colors.primary.lighter, 0.3),
            },
          },
        },
      },
